== nootrate source v1
[nootrate](https://nootrate.herokuapp.com/)
...
css framework is [semantic ui](http://semantic-ui.com/)
...
* tag pages which list subjects based on their ratings
* subject lists which can be filtered by multiple tags
* 'related' subjects panel (based on related tags)

eventual features
* filter subjects by tag ratings
